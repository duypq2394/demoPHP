...
function hyoji() {
	...
	print("<div style=\"position:absolute; left:90px; top:90px\">\n");  //200903追加
	  print("<form name=\"myFORM\" action=\"seikyu.php\" method=\"POST\">\n");
	  ...
	  print("</form>\n");
	print("</div>\n");
	print("<div style=\"position:absolute; left:495px; top:85px\">\n");
	  print("<form name=\"myFORM\" action=\"seikyu.php\" method=\"POST\">\n");
	  print("<table border=\"0\">\n");
...
function hyoji_meisai001() {
	...
	print("<div style=\"position:absolute; left:20px; top:140px\">\n");
	  print("<form action=\"seikyu.php\" method=\"POST\">\n");
	  ...
	  print("</td>\n");
	  print("<td rowspan=\"2\" style=\"vertical-align:bottom\">\n");
	  print("<input type=\"image\" src=\"gazo/kosin.gif\">\n");
	  print("</td>\n");
	  print("<tr><td>\n");
	  print("<input type=\"text\" name=\"juchu_no\" value=\"$juchu_no\" style=\"width: 50px; height: 19px\">\n");
	  print("</td>\n");
	  print("<td>\n");
	  print("<input type=\"text\" name=\"shohin_mei\" value=\"$shohin_mei\" style=\"width: 170px; height: 19px\">\n"); /*29-28*/
	  print("</td>\n");
	  print("<td>\n");
	  if ($denpyo_kubun == '3') {
	      $kagensan=$_SESSION['kagensan'];
	      print("<input type=\"text\" name=\"suryo\" value=\"$kagensan\" style=\"text-align: right ;width: 53px; height: 19px\">\n");
	  } else {
	      print("<input type=\"text\" name=\"suryo\" value=\"$suryo\" style=\"text-align: right ;width: 53px; height: 19px\">\n");
	  }
	  print("</td>\n");
	  print("<td>\n");
	  print("<input type=\"text\" name=\"tani\" value=\"$tani\" style=\"text-align: right;width: 55px; height: 19px\">\n");
	  print("</td>\n");
	  print("<td>\n");
	  print("<input type=\"text\" name=\"tanka\" value=\"$tanka\" style=\"text-align: right;width: 55px; height: 19px\">\n");
	  print("</td>\n");
	  print("<td>\n");
	  if ($denpyo_kubun == '3') {
	      $kingaku="";
	      print("<input type=\"text\" name=\"kingaku\" value=\"$kingaku\" style=\"text-align: right;width: 67px; height: 19px\">\n");
	  } else {
	      print("<input type=\"text\" name=\"kingaku\" value=\"$kingaku\" style=\"text-align: right;width: 67px; height: 19px\">\n");
	  }
	  print("</td>\n");
	  print("<td>\n");
	  print("<input type=\"text\" name=\"biko\" value=\"$biko\" style=\"width: 110px; height: 19px\">\n");
	  print("</td>\n");
	  print("</table>\n");
	  print("<input type=\"hidden\" name=\"tanto_mei\" value=\"$tanto_mei\">\n");
	  print("<input type=\"hidden\" name=\"check_item\" value=\"更新\">\n");
	  print("</form>\n");
	print("</div>\n");
}
...
function hyoji_meisai002() {
	...
	print("<div style=\"position:absolute; left:323px; top:283px\">\n");  //2009.03追加
	...
	print("<form action=\"seikyu.php\" method=\"POST\">\n");
	print("<div style=\"position:absolute; left:390px; top:200px\">\n");
	print("<table border=\"1\" style=\"border-spacing:0px\">\n");
	...
	print("<tr><td colspan=\"2\"><input type=\"text\" name=\"denpyo_no\" value=\"$denpyo_no\" style=\"width: 150px; height: 19px\"></td>\n");
	print("<td>\n");
	...
	print("<div style=\"position:absolute; left:20px; top:300px\">\n");
		print("<table border=\"1\" style=\"border-spacing:0px\">\n");
		print("<tr style=\"background-color: #B0B0FF\"><td><span style=\"font: 10pt/10pt 'MS PGothic'\">受注NO</span></td>\n");
		print("<td><span style=\"font: 10pt/10pt 'MS PGothic'\">品名・規格</span></td>\n");
		print("<td><span style=\"font: 10pt/10pt 'MS PGothic'\">数量</span></td>\n");
	...
	if (($ken == '有') or ($ken == '無')) {
		...
		if ($resultNumRow > 0) {
			...
			while ($rowCount < $resultNumRow) {
				...
				print("<form action=\"seikyu.php\" method=\"POST\">\n");
				print("<tr><td>\n");
				print("<input type=\"text\" name=\"juchu_no\" value=\"$juchu_no\" style=\"width: 60px; height: 19px\">\n");
				print("</td>\n");
				print("<td>\n");
				print("<input type=\"text\" name=\"shohin_mei\" value=\"$shohin_mei\" style=\"width: 200px; height: 19px\">\n");/*170-200*/
				print("</td>\n");
				print("<td>\n");
	...
	if ($rowCount < 4) {
		...
		print("<tr><td>\n");
		print("<input type=\"text\" name=\"a11\" value=\"$a11\" style=\"width: 60px; height: 19px\">\n");
		print("</td>\n");
		print("<td>\n");
		print("<input type=\"text\" name=\"a22\" value=\"$a22\" style=\"width: 200px; height: 19px\">\n");
		print("</td>\n");
		print("<td>\n");
	...
	print("<input type=\"text\" name=\"gokei\" value=\"$gokei\"style=\"text-align: right;width: 77px; height: 19px\">\n");
	print("</td>\n");
	print("</table>\n");
	print("</form>\n");
	print("</div>\n");

	print("<div style=\"position:absolute; left:483px; top:468px\">\n");
		print("<form action=\"seikyu.php\" method=\"POST\">\n");
	...
	print("<div style=\"position:absolute; left:550px; top:468px\">\n");
		print("<form action=\"seikyu.php\" method=\"POST\">\n");
		print("<input type=\"image\" src=\"gazo/clear.gif\">\n");
		print("<input type=\"hidden\" name=\"check_item\" value=\"クリア\">\n");
		print("</form>\n");
	print("</div>\n");

	print("<div style=\"position:absolute; left:617px; top:468px\">\n");
		print("<form action=\"seikyu.php\" method=\"POST\">\n");
	...
	print("<div style=\"position:absolute; left:483px; top:505px\">\n");
		print("<form action=\"seikyu.php\" method=\"POST\">\n");
		print("<table border=\"0\">\n");
		print("<tr>\n");
...
function hyoji_shori() {
	...
	print("<div style=\"position:absolute; left:246px; top:190px\">\n");
...
//print("suryo_count=$suryo_count<br>\n");
	...
	if (!empty($juchu_no) and ($torihikisaki_no != $torihikisaki_stok)) {
		...
		$torihikisaki_no = htmlspecialchars($torihikisaki_no, ENT_QUOTES, "UTF-8");
		print("<div style=\"position:absolute; left:190px; top:210px\">\n");
...
print("<div style=\"position:absolute; left:622px; top:50px\">\n");
...
print("<div style=\"position:absolute; left:580px; top:14px\">\n");
